...
#ifndef VENDOR_EDIT
//Nan.Zhong@PSW.MM.AudioDriver.Codec, 2020/06/11, Remove for Reduce glitch during headset record
...
#ifndef VENDOR_EDIT
//Nan.Zhong@PSW.MM.AudioDriver.Codec, 2020/06/11, Modify for Reduce glitch during headset record
...
//Nan.Zhong@PSW.MM.AudioDriver.Codec, 2020/06/11, Modify for Reduce glitch during headset record
	...
	case SND_SOC_DAPM_POST_PMD:
#ifdef VENDOR_EDIT
//Nan.Zhong@PSW.MM.AudioDriver.Codec, 2020/06/11, Add for Reduce glitch during headset record
		wcd938x_tx_connect_port(component, ADC1 + (w->shift), 0, false);
		if (w->shift == 1 &&
			test_bit(AMIC2_BCS_ENABLE, &wcd938x->status_mask)) {
			if (!wcd938x->bcs_dis)

 ...
 *Add for fix lvimfq and KTV2.0 not support sample_rate issue.
 */
	     ...
	     int session_type)
{
	 ...
	 *Add for fix lvimfq and KTV2.0 not support sample_rate issue.
	 */
	if (((topology == VOICE_TOPOLOGY_LVIMFQ_TX_DM) || (topology == AUDIO_TOPOLOGY_KTV))
		&& (rate != ADM_CMD_COPP_OPEN_SAMPLE_RATE_48K)) {
...
#ifdef VENDOR_EDIT
//Xiaoke.Zhi@PSW.MM.AudioDriver.feature, 2020/2/24, add for KTV 2.0

...
#ifdef VENDOR_EDIT
//LiuWei@NETWORK.RF 2020/06/06, Add for report modem crash uevent
extern void subsystem_set_modem_crash_reason(char *reason);
#endif
...
static inline void subsystem_set_modem_crash_reason(char *reason)
{
	return;
}
#endif

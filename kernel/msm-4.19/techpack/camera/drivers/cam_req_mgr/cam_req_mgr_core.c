...
#ifdef VENDOR_EDIT
/*added by yufeng@camera, 20191109, qcom patch for hw sync*/
...
//wangguoliang@camera 20191127 add for request id is not applied properly for ISP in CRM
...
static int __cam_req_mgr_process_sof_freeze(void *priv, void *data)
{
	...
	msg.session_hdl = session->session_hdl;
#ifdef VENDOR_EDIT
    /*Modify by shentao1@camera 20190918, for set value larger than 6s, long exposure fail.*/

...
#ifdef VENDOR_EDIT
/*naresh.bommena@Camera, 2019/11/28, add for check phy reset is proper*/
	...
	#ifdef VENDOR_EDIT
	/*naresh.bommena@camera, 2019/11/06, modify for ITS test_jitter timestamp variation */
	...
	struct cam_ife_csid_hw *csid_hw, bool reset_hw)
{
	...
	if (rc <= 0) {
#ifdef VENDOR_EDIT
        /* chengqiangwei@Cam.Drv 20191129 qcom patch for Can not INIT IFE CID, case: #04326417 */
...
#ifdef VENDOR_EDIT
/* naresh.bommena@Camera, 2019/11/25, add for CCIF violation reg dump */

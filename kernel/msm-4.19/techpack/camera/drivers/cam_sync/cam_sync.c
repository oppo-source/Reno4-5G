...
#ifdef VENDOR_EDIT
// chengqiangwei@camera 20191204 add CSLCreatePrivateFenceHW cause SIGABRT for monkey test case 04334246
...
int cam_sync_get_obj_ref(int32_t sync_obj)
{
	...
	if (row->state != CAM_SYNC_STATE_ACTIVE) {
		...
		#ifdef VENDOR_EDIT
		/*Added linyingpiao@Cam.Drv, 20191214, for check OPPOVideoLiveSnapshotYUVSStab_IFE0*/
		CAM_ERR(CAM_SYNC,

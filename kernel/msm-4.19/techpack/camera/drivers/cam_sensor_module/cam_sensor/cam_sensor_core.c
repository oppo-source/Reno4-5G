...
/*add by lixin@camera 20190924, for distinguish the second source camera module*/
	...
	/*add by cuikang@camera 20200418, for distinguish the second source camera module*/
...
/*add by Fangyan @ Cam.Drv 20200317,for force the replace module not to probe the normal bin*/
			...
			rc = cam_cci_i2c_read(&ee_cci_client,
				 ...
				 CAMERA_SENSOR_I2C_TYPE_BYTE);
			/*add by tangruiye@camera 20200603, for distinguish the second source camera module*/
			rc = cam_cci_i2c_read(&ee_cci_client,
	...
	void *arg)
{
	...
	struct cam_sensor_power_ctrl_t *power_info =
		&s_ctrl->sensordata->power_info;
#ifdef VENDOR_EDIT
	/*Zhixian.Mai@Cam.drv 20200305 ,add for tmf8801  laser driver*/
	static char strPrjname[10] = {0};
...
#ifdef VENDOR_EDIT
/*zhixian.mai@cam 20200427 add for ams-laser*/
		CAM_INFO(CAM_SENSOR,

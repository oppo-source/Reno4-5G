...
#ifdef VENDOR_EDIT
//gong.yuanzhu@PSW.BSP.kernel.storage, 2020/05/18, Add for sdcardfs delete dcim record
...
#ifdef VENDOR_EDIT
//gong.yuanzhu@PSW.BSP.kernel.storage.1444856, 2020/05/18, Add for avoid crash when dcim proctect
